...
class Pantry(wx.Panel):
    ...
    def resize_main(self, event=None):
        ...
        self.ingredients_list.SetPosition((50, 60))
        self.ingredients_list.SetSize(int(size[0]/2)-40, size[1]-150)
        self.tools_list.SetPosition((int(size[0]/2)+20, 60))
        self.tools_list.SetSize(int(size[0]/2)-30, size[1] - 150)
